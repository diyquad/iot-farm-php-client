      ...
      <div class="sidebar">
        ...
        <div class="sidebar-inner">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="iot-farm.php"><i class="icon-home"></i><span>Live</span></a></li>
            <li class="nav-parent">
              <a href="iot-farm.php"><i class="icon-puzzle"></i><span>Live</span> <span class="fa arrow"></span></a>
